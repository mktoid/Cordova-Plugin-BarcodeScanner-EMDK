...
EnterpriseBarcode.prototype.stopSoftRead = function (successCallback, errorCallback) {
	argscheck.checkArgs('fF', 'EnterpriseBarcode.stopSoftRead', arguments);
	exec(successCallback, errorCallback, "EnterpriseBarcode", "stopSoftRead", []);
};
